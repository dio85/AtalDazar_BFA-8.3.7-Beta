...
void AddSC_boss_meljarak()
{
    ...
    RegisterAuraScript(spell_meljarak_corrosive_resin_aura);
    RegisterSpellScript(spell_whirling_blade);
    RegisterSpellScript(spell_meljarak_corrosive_resin);
    RegisterSpellScript(spell_amber_prison_selector);
    RegisterSpellScript(spell_meljarak_amber_prison);
    RegisterSpellScript(spell_mending);
    RegisterSpellScript(spell_meljarak_impaling_spear);
    RegisterSpellScript(spell_meljarak_korthik_strike);
    RegisterSpellScript(spell_meljarak_berserk);
    RegisterSpellScript(spell_meljarak_wind_bomb);
    RegisterSpellScript(spell_whirling_blade_eff);
}
