...
class go_time_lost_shrine_ti : public GameObjectScript
{
    public:
        ...
        void OnLootStateChanged(GameObject* go, uint32 state, Unit* unit) override
        {
            ...
            go->GetScheduler().Schedule(300000ms, [this, go](TaskContext context)
            {
...
class go_gleaming_crane_statue_ti : public GameObjectScript
{
    public:
        ...
        bool OnGossipSelect(Player* player, GameObject* /*go*/, uint32 /*sender*/, uint32 /*action*/) override
        {
            ...
            player->GetScheduler().Schedule(6000ms, [this, player](TaskContext context)
            {
    ...
    public:
        ...
        struct npc_emperor_shaohaoAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                Trinity::Containers::RandomShuffle(buf);
        ...
        struct npc_timeless_spectralsAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                if (auto addon = me->GetCreatureAddon())
                    if (addon->emote != 0)
                        me->HandleEmoteCommand(addon->emote);
            }
    ...
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature) override
        {
            ...
            if (player->GetQuestStatus(33211) == QUEST_STATUS_INCOMPLETE)
            {
                ...
                {
                    case 1:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_01, GORLOCS, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_01, MURGHOULS, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_01, WOLVAR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_01, MURLICHES, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_01, creature->GetGUID());
                        break;
                    case 2:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_02, DEFECTIVE_ELEKK_TURD, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_02, CRYSTAL_DEATH_TRAP, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_02, WORTHLESS_ELEKK_DUNG, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_02, RADIOACTIVE_BIOHAZARD, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_02, creature->GetGUID());
                        break;
                    case 3:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_03, GELBIN_MEKKATORQUE, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_03, MILLHOUSE_MANASTORM, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_03, SICCO_THERMAPLUGG, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_03, FIZZCRANK_FULLTHROTTLE, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_03, creature->GetGUID());
                        break;
                    case 4:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_04, CRIMSON_RING, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_04, EMERALD_CIRCLE, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_04, EARTHEN_RING, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_04, CENARION_CIRCLE, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_04, creature->GetGUID());
                        break;
                    case 5:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_05, CHENETA, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_05, KRISTINE_DENNY, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_05, TATAI, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_05, DELA_RUNETOTEM, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_05, creature->GetGUID());
                        break;
                    case 6:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_06, GOREHOOF, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_06, TOOTHGNASHER, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_06, BLOODHORN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_06, STEELMAULER, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_06, creature->GetGUID());
                        break;
                    case 7:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_07, RED_DRAGONFLIGHT, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_07, BLUE_DRAGONFLIGHT, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_07, GREEN_DRAGONFLIGHT, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_07, BRONZE_DRAGONFLIGHT, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_07, creature->GetGUID());
                        break;
                    case 8:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_08, ACHERUS, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_08, NAXXANAR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_08, KOLRAMAS, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_08, NAXXRAMAS, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_08, creature->GetGUID());
                        break;
                    case 9:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_09, MAAKA, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_09, GRIMATH, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_09, TALAK, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_09, RAWIRI, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_09, creature->GetGUID());
                        break;
                    case 10:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_10, SHAMAN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_10, STORMCALLER, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_10, ARCHDRUID, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_10, FAR_SEER, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_10, creature->GetGUID());
                        break;
                    case 11:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_11, SNAKECOIL_CAVERN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_11, SERPENTINE_BASIN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_11, COILFANG_RESERVOIR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_11, SPIRALFANG_CISTERN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_11, creature->GetGUID());
                        break;
                    case 12:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_12, EMMA_HARRINGTON, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_12, CALISSA_HARRINGTON, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_12, VANESSA_WHITEHALL, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_12, KATRINA_WHITEHALL, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_12, creature->GetGUID());
                        break;
                    case 13:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_13, SHARP_CLAW, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_13, RAZOR_TOOTH, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_13, SHARP_TOOTH, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_13, RAZOR_CLAW, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_13, creature->GetGUID());
                        break;
                    case 14:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_14, QUEEN_LIA_GREYMANE, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_14, QUEEN_MALIA_GREYMANE, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_14, QUEEN_LIRIA_GREYMANE, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_14, QUEEN_MIA_GREYMANE, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_14, creature->GetGUID());
                        break;
                    case 15:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_15, TIFFIN_WINDEMERE_WRYNN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_15, THERESE_ANNE_WRYNN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_15, THERESE_ANGHARAD_WRYNN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_15, TIFFIN_ELLERIAN_WRYNN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_15, creature->GetGUID());
                        break;
                    case 16:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_16, TENEBRON_VESPERON_AND_SHADRON, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_16, TENEBRON_VESPERON_AND_HALION, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_16, THERALION_SHADRON_AND_ABYSSION, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_16, THERALION_HALION_AND_ABYSSION, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_16, creature->GetGUID());
                        break;
                    case 17:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_17, AMANTHUL, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_17, NORGANNON, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_17, EONAR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_17, KHAZGOROTH, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_17, creature->GetGUID());
                        break;
                    case 18:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_18, VELEN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_18, AKAMA, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_18, MARAAD, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_18, NOBUNDO, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_18, creature->GetGUID());
                        break;
                    case 19:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_19, KARESH, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_19, XARODI, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_19, KHURAL, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_19, XOROTH, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_19, creature->GetGUID());
                        break;
                    case 20:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_20, EREDRUIN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_20, SAYAAD, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_20, SHIVARRA, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_20, EREDAR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_20, creature->GetGUID());
                        break;
                    case 21:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_21, TERON_GOREFIEND, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_21, ARTHAS_MENETHIL, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_21, ALEXANDROS_MOGRAINE, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_21, KOLTIRA_DEATHWEAVER, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_21, creature->GetGUID());
                        break;
                    case 22:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_22, FELLARI_SWIFTARROW, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_22, HOLIA_SUNSHIELD, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_22, YANA_BLOODSPEAR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_22, VALEA_TWINBLADES, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_22, creature->GetGUID());
                        break;
                    case 23:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_23, SWIFTWING, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_23, SHARPBEAK, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_23, SKYREE, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_23, STORMBEAK, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_23, creature->GetGUID());
                        break;
                    case 24:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_24, SHIRVALLAH, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_24, KIMBUL, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_24, MUEHZALA, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_24, SHADRA, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_24, creature->GetGUID());
                        break;
                    case 25:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_25, PRINCE_ARTHAS_MENETHIL, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_25, KING_LLANE_WRYNN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_25, UTHER_THE_LIGHTBRINGER, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_25, KING_TERENAS_MENETHIL_II, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_25, creature->GetGUID());
                        break;
                    case 26:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_26, MAGHAR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_26, FELBLOOD, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_26, MOKNATHAL, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_26, FEL_ORC, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_26, creature->GetGUID());
                        break;
                    case 27:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_27, BORELA_MIR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_27, BELAN_SHI, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_27, AVRAL_SHI, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_27, ALENA_MIR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_27, creature->GetGUID());
                        break;
                    case 28:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_28, DRAKAS_FURY, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_28, HELLSCREAMS_FURY, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_28, AGGRAS_FURY, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_28, DUROTANS_FURY, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_28, creature->GetGUID());
                        break;
                    case 29:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_29, BILLY, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_29, WILLIAM, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_29, GILES, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_29, TOBIAS, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_29, creature->GetGUID());
                        break;
                    case 30:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_30, TELDRASSIL, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_30, WELL_OF_ETERNITY, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_30, NORDRASSIL, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_30, MOONWELLS, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_30, creature->GetGUID());
                        break;
                    case 31:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_31, CORPRETHAR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_31, ALDURTHAR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_31, ANGRATHAR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_31, MORDRETHAR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_31, creature->GetGUID());
                        break;
                    case 32:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_32, ASHANOR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_32, MISTSILVER, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_32, FEONIR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_32, MIRADOR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_32, creature->GetGUID());
                        break;
                    case 33:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_33, WHITECLAW_CLAN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_33, WARSONG_CLAN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_33, FROSTWOLF_CLAN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_33, ICEFANG_CLAN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_33, creature->GetGUID());
                        break;
                    case 34:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_34, SCARLET_FEVER, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_34, BLOOD_POX, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_34, CRIMSON_FEVER, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_34, RED_POX, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_34, creature->GetGUID());
                        break;
                    case 35:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_35, GALAKROND, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_35, VERANUS, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_35, ZEPTEK, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_35, VYLETONGUE, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_35, creature->GetGUID());
                        break;
                    case 36:
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_36, PEROTHARN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_36, GARAXXAS, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_36, XAVIUS, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                        AddGossipItemFor(player, GOSSIP_MENU_QUESTION_36, VYLETONGUE_2, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                        SendGossipMenuFor(player, GOSSIP_TEXT_QUESTION_36, creature->GetGUID());
                        break;
                }
            }
            else
        ...
        bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action) override
        {
            ...
            if (action == GOSSIP_ACTION_INFO_DEF + 1) // false
                SendGossipMenuFor(player, GOSSIP_INCORRECT, creature->GetGUID());
            else // true
            {
                player->KilledMonsterCredit(NPC_A_TIMELESS_QUESTION_CREDIT);
                SendGossipMenuFor(player, GOSSIP_CORRECT, creature->GetGUID());
            }
...
struct npc_highwind_albatross : public ScriptedAI
{
    ...
    void DamageTaken(Unit* attacker, uint32& damage) override
    {
        ...
        if (me->GetVehicleKit() && me->GetVehicleKit()->HasEmptySeat(0) && !attacker->IsOnVehicle())
        {
            ...
            me->GetScheduler().Schedule(3000ms, [this](TaskContext context) { me->GetMotionMaster()->MovePath(me->GetEntry(), true); });
        }
    }
    ...
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature) override
        {
            ...
            if (!creature->FindNearestCreature(RARE_KARKANOS, 50.0f, true))
                AddGossipItemFor(player, 60013, 0, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
            SendGossipMenuFor(player, player->GetGossipTextId(creature), creature->GetGUID());
            return true;
        }
        ...
        bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action) override
        {
            ...
            {
                creature->AI()->Talk(0);
                creature->GetScheduler().Schedule(5000ms, [this, creature](TaskContext context)
                {
                    creature->HandleEmoteCommand(0);
                    creature->AI()->Talk(1);
    ...
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature) override
        {
            ...
            if (!player->IsDailyQuestDone(QUEST_ZARHYM_TRACKER))
                AddGossipItemFor(player, 60014, 0, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
...
struct npc_dread_ship_vazuvius : public ScriptedAI
{
    ...
    void Reset() override
    {
        ...
        if (me->GetPositionZ() < -5.0f)
        {
            ...
            me->GetScheduler().Schedule(10000ms, [this, pos](TaskContext context)
            {
...
class go_crane_nest : public GameObjectScript
{
    public:
        ...
        void OnLootStateChanged(GameObject* go, uint32 state, Unit* unit) override
        {
            ...
            go->GetScheduler().Schedule(60000ms, [go](TaskContext context)
            {
    ...
    public:
        ...
        bool OnGossipHello(Player* player, GameObject* go) override
        {
            ...
            if (Creature* captain = go->SummonCreature(NPC_CAPTAIN, -213.352f, -4715.245f, 13.070f, 4.343475f))
            {
                ...
                captain->AI()->Talk(0);
                captain->GetScheduler().Schedule(5000ms, [captain](TaskContext context) { captain->AI()->Talk(1); });
                captain->GetScheduler().Schedule(10000ms, [captain](TaskContext context) { captain->AI()->Talk(2); });
                captain->GetScheduler().Schedule(15000ms, [captain](TaskContext context) { captain->AI()->Talk(3); });
                captain->GetScheduler().Schedule(20000ms, [captain](TaskContext context)
                {
                    captain->AI()->Talk(4);
            ...
            go->GetScheduler().Schedule(3600000ms, [go](TaskContext context)
            {
                go->RemoveFlag(GO_FLAG_INTERACT_COND);
            });
            return true;
...
class spell_censer_of_eternal_agony : public AuraScript
{
    ...
    {
        GetOwner()->ToPlayer()->AddUnitFlag2(UNIT_FLAG2_IGNORE_REPUTATION);
        GetOwner()->ToPlayer()->UpdatePvP(true);
    }

    void HandleRemove(AuraEffect const*, AuraEffectHandleModes)
    {
        GetOwner()->ToPlayer()->RemoveUnitFlag2(UNIT_FLAG2_IGNORE_REPUTATION);
...
void AddSC_timeless_isle()
{
    ...
    new npc_zarhym_1();
    new npc_zarhym_2();
    RegisterCreatureAI(npc_dread_ship_vazuvius);
    RegisterCreatureAI(npc_evermaw);
    RegisterCreatureAI(npc_timeless_turtles);
    RegisterCreatureAI(npc_cranegnasher);
    RegisterCreatureAI(npc_nice_sprite);
    RegisterCreatureAI(npc_highwind_albatross);
    ...
    //RegisterSpellScript(spell_create_timeless_item);
    //RegisterSpellScript(spell_create_timeless_item_from_cache);
    RegisterSpellScript(spell_eternitys_embrace);
    RegisterSpellScript(spell_cat_defensive_leap);
    RegisterSpellScript(spell_timelesscat_pounce);
    RegisterSpellScript(spell_evermaw_time_portals);

    RegisterAuraScript(spell_crane_wings);
    RegisterAuraScript(spell_bloody_coin_proc);
    RegisterAuraScript(spell_censer_of_eternal_agony);
    RegisterAuraScript(spell_book_of_the_ages);
    RegisterAuraScript(spell_gulp_frog_toxin);
